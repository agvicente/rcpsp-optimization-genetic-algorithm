...
class Task:
    def __init__(self, name: str, predecessors: np.ndarray['Task'] = [], sucessors: np.ndarray['Task'] = [], duration: int = 0, renewable_resources: np.ndarray[int] = []):
        self.name = name
...
class Schedule:
    def __init__(self, renewable_resources: np.ndarray[Resource] = [], tasks: np.ndarray[Task] = []):
